				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (this.getResultCode() != Activity.RESULT_OK) {
							...
							final CharSequence tickerText = "Download completed successfully";
							final CharSequence contentTitle = "Download completed successfully";
							final CharSequence contentText = "Tweets downloaded from server";
